...
\begin{note}
    \xfield{$\lim\limits_{x\to1}\frac{\ln(x)}{x-1}=$ ? \\$\mbox{For } a > 1: \,$\\$\lim\limits_{x \to 0^+} \log_a x = $ ?\\$\lim\limits_{x \to \infty} \log_a x = $ ?\\$\lim\limits_{x \to -\infty} a^x = $ ?\\$\mbox{If } a < 1: \,$\\$\lim\limits_{x \to -\infty} a^x =$ ?}
    \xfield{$\lim\limits_{x\to1}\frac{\ln(x)}{x-1}=1$\\$\mbox{For } a > 1: \,$\\$\lim\limits_{x \to 0^+} \log_a x = -\infty$\\$\lim\limits_{x \to \infty} \log_a x = \infty$\\$\lim\limits_{x \to -\infty} a^x = 0$\\$\mbox{If } a < 1: \,$\\$\lim\limits_{x \to -\infty} a^x = \infty$}
\end{note}
